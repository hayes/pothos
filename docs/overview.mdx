...
- A set of plugins for common use cases:
  - [`@giraphql/plugin-auth`](/plugins-auth): A plugin for adding authorization checks throughout
    your schema
  ...
  - [`@giraphql/plugin-mocks`](/plugins-mocks): A plugin for mocking out resolvers in your schema.
