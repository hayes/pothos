...
import { ArgBuilder, InputFieldMap } from '../index.ts';
export default class RootFieldBuilder<Types extends SchemaTypes, ParentShape, Kind extends FieldKind = FieldKind> extends BaseFieldUtil<Types, ParentShape, Kind> {
    ...
    boolean<Args extends InputFieldMap, ResolveShape, ResolveReturnShape, Nullable extends FieldNullability<"Boolean"> = Types["DefaultFieldNullability"]>(options: Omit<FieldOptionsFromKind<Types, ParentShape, "Boolean", Nullable, Args, Kind, ResolveShape, ResolveReturnShape>, "type">) {
        return this.createField<Args, "Boolean", Nullable>({
            ...options,
            type: "Boolean",
        });
    }
    float<Args extends InputFieldMap, Nullable extends FieldNullability<"Float">, ResolveShape, ResolveReturnShape>(options: Omit<FieldOptionsFromKind<Types, ParentShape, "Float", Nullable, Args, Kind, ResolveShape, ResolveReturnShape>, "type">) {
        return this.createField<Args, "Float", Nullable>({
            ...options,
            type: "Float",
        });
    }
    id<Args extends InputFieldMap, Nullable extends FieldNullability<"ID">, ResolveShape, ResolveReturnShape>(options: Omit<FieldOptionsFromKind<Types, ParentShape, "ID", Nullable, Args, Kind, ResolveShape, ResolveReturnShape>, "type">) {
        return this.createField<Args, "ID", Nullable>({ ...options, type: "ID" });
    }
    int<Args extends InputFieldMap, Nullable extends FieldNullability<"Int">, ResolveShape, ResolveReturnShape>(options: Omit<FieldOptionsFromKind<Types, ParentShape, "Int", Nullable, Args, Kind, ResolveShape, ResolveReturnShape>, "type">) {
        return this.createField<Args, "Int", Nullable>({ ...options, type: "Int" });
    }
    string<Args extends InputFieldMap, ResolveShape, ResolveReturnShape, Nullable extends FieldNullability<"String"> = Types["DefaultFieldNullability"]>(options: Omit<FieldOptionsFromKind<Types, ParentShape, "String", Nullable, Args, Kind, ResolveShape, ResolveReturnShape>, "type">) {
    ...
    booleanList<Args extends InputFieldMap, ResolveShape, ResolveReturnShape, Nullable extends FieldNullability<[
        "Boolean"
    ]> = Types["DefaultFieldNullability"]>(options: Omit<FieldOptionsFromKind<Types, ParentShape, [
        "Boolean"
    ...
    idList<Args extends InputFieldMap, Nullable extends FieldNullability<[
        "ID"
    ]>, ResolveShape, ResolveReturnShape>(options: Omit<FieldOptionsFromKind<Types, ParentShape, [
        "ID"
    ], Nullable, Args, Kind, ResolveShape, ResolveReturnShape>, "type">) {
        return this.createField<Args, [
            "ID"
