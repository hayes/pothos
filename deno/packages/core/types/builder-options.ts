...
import { BaseEnum, EnumParam, FieldNullability, FieldRef, InputFieldRef, inputFieldShapeKey, InputRef, InterfaceParam, InterfaceRef, MaybePromise, MaybePromiseWithInference, NormalizeNullableFields, ObjectParam, ObjectRef, OutputShape, SchemaTypes, ShapeFromTypeParam, TypeParam, } from '../index.ts';
...
export type Resolver<Parent, Args, Context, Type, Return = unknown> = (parent: Parent, args: Args, context: Context, info: GraphQLResolveInfo) => MaybePromiseWithInference<Type extends unknown[] ? Readonly<Return extends MaybePromise<readonly Promise<unknown>[]> ? Promise<Type[number]>[] : Type> : Type, Return> & Return;
