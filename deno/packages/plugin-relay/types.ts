import { GraphQLResolveInfo } from 'https://cdn.skypack.dev/graphql@v15.5.0?dts';
import { FieldKind, FieldNullability, FieldOptionsFromKind, FieldRequiredness, InputFieldMap, InputFieldRef, InputFieldsFromShape, InputShape, InputShapeFromFields, inputShapeKey, InterfaceParam, MaybePromise, ObjectParam, ObjectRef, ObjectTypeOptions, OutputRefShape, OutputShape, OutputType, Resolver, SchemaTypes, ShapeFromTypeParam, } from '../core/index.ts';
...
export type NodeBaseObjectOptionsForParam<Types extends SchemaTypes, Param extends ObjectParam<Types>, Interfaces extends InterfaceParam<Types>[]> = Omit<ObjectTypeOptions<Types, Param, OutputShape<Types, Param>, Interfaces>, "isTypeOf"> & 
...
export type NodeObjectOptions<Types extends SchemaTypes, Param extends ObjectParam<Types>, Interfaces extends InterfaceParam<Types>[]> = NodeBaseObjectOptionsForParam<Types, Param, Interfaces> & {
    id: Omit<FieldOptionsFromKind<Types, OutputShape<Types, Param>, "ID", false, {}, "Object", OutputShape<Types, Param>, MaybePromise<OutputShape<Types, "ID">>>, "args" | "nullable" | "type">;
