...
export const RESOURCES: Resource[] = [
  // ── Guides ─────────────────────────────────────────────────────────
  {
    ...
    description:
      'Long-form walkthrough of Pothos + Prisma + GraphQL Yoga + Relay client — the modern recommended stack.',
  ...
  {
    id: 'guide-relia-nestjs',
    category: 'guide',
    title: 'A Type-Safe Backend with NestJS, Prisma, Pothos & GraphQL',
    description: 'Guided narrative for NestJS users wiring up Pothos.',
    url: 'https://reliasoftware.com/blog/build-a-type-safe-backend-with-nestjs-prisma-pothos-graphql',
    author: 'Hien Le · Relia Software',
    date: '2025-04-14',
    source: 'blog',
  },
  {
    id: 'guide-pothos-eval',
    category: 'guide',
    title: 'Pothos Evaluation Report',
    description: 'Detailed five-dimension evaluation — useful for adopters comparing schema builders.',
    url: 'https://dev.to/xcfox/pothos-evaluation-report-3d91',
    author: 'xcfox',
    date: '2026-01-05',
    source: 'blog',
  },
  {
    id: 'guide-vs-typegraphql-nexus-2026',
    category: 'guide',
    title: 'Pothos vs TypeGraphQL vs Nexus (2026)',
    description: 'Up-to-date comparison guide with code, Prisma N+1 coverage, and migration paths.',
    url: 'https://www.pkgpulse.com/guides/pothos-vs-typegraphql-vs-nexus-code-first-graphql-2026',
    author: 'PkgPulse',
    date: '2026-03-09',
    source: 'blog',
  },
  ...
  {
    id: 'tool-drizzle-generator',
    category: 'tool',
    title: 'pothos-drizzle-generator',
    description: 'Auto-generate a full CRUD Pothos schema from Drizzle definitions.',
    url: 'https://github.com/node-libraries/pothos-drizzle-generator',
    author: 'SoraKumo · node-libraries',
  ...
  },
  {
    ...
    description: 'Alternative Prisma codegen for Pothos with active 2025 maintenance.',
  ...
  {
    id: 'tool-effect-archived',
    category: 'tool',
    title: 'pothos-plugin-effect (archived reference)',
    description: 'Effect-TS integration for Pothos resolvers — archived but useful as a reference for Effect users.',
    url: 'https://github.com/iamchanii/pothos-plugin-effect',
    author: 'Chanhee Lee',
    authorUrl: 'https://github.com/iamchanii',
    source: 'github',
  },
  ...
  },
  {
    ...
    description: 'End-to-end reference: Pothos, Prisma, GraphQL Yoga, Better Auth, Relay client. Companion to the "Revisiting GraphQL 2025" article.',
  ...
  {
    id: 'tpl-nextjs-pothos-apollo',
    category: 'template',
    title: 'Next.js + Pothos + Prisma + Apollo',
    description: 'Fully wired Next.js + Pothos + Apollo template (Turborepo flavor also available).',
    url: 'https://github.com/ivanms1/nextjs-prisma-graphql-pothos-apollo',
    author: 'Ivan Montiel',
    authorUrl: 'https://github.com/ivanms1',
    source: 'github',
  },
  {
    id: 'tpl-kriasoft-starter',
    category: 'template',
    title: 'graphql-starter-kit',
    description: 'High-traffic Cloud Functions + GraphQL + PostgreSQL + React monorepo, pre-configured with Pothos and Yoga (~4k stars).',
    url: 'https://github.com/kriasoft/graphql-starter-kit',
    author: 'Kriasoft',
    authorUrl: 'https://github.com/koistya',
    source: 'github',
  },
