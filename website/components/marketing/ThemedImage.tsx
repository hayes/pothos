...
export function ThemedImage({ src, alt, ...rest }: Props) {
  ...
  // The source is an external SVG with embedded prefers-color-scheme
  // styles; Next Image's optimizer would strip the inline <style> block.
  return (
    // biome-ignore lint/performance/noImgElement: external theme-adaptive SVG, see above
