...
export function CommentCard({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: the card nests its own textarea and buttons, so it cannot be a <button>
    <div
      className="rp-card"
    ...
    >
      ...
      {open && (
        // biome-ignore lint/a11y/noStaticElementInteractions: wrapper only stops events bubbling to the card
