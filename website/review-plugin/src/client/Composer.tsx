...
export function Composer({ position, preview, onSubmit, onCancel }: ComposerProps) {
  ...
  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: popover only stops clicks bubbling to the page
    // biome-ignore lint/a11y/useKeyWithClickEvents: popover only stops clicks bubbling to the page
    <div
      ref={ref}
