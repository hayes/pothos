...
<Callout type="info">
  See also: [Prisma objects](./objects) to define your first type, [Relations](./relations) to connect them, or the [Prisma plugin overview](../prisma) for the full picture.
</Callout>
