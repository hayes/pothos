...
This page assumes the [generated types and builder](./setup) are already wired up. The examples add two columns to the base `Player` model, an `isCaptain` discriminator and an optional `bio`:
