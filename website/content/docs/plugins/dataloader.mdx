...
description: Batch object and relation loads, preserve result order, and cache records per request.
---
...
<include cwd lang="typescript" meta='playground example="plugin-dataloader"'>playground-examples/plugin-dataloader/schema.ts#loadable-user</include>
...
<include cwd lang="typescript" meta='playground example="plugin-dataloader"'>playground-examples/plugin-dataloader/schema.ts#batching-report</include>
