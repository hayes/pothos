...
<includeregions cwd lang="typescript" meta='playground example="plugin-with-input"'>playground-examples/plugin-with-input/schema.ts#default-input,custom-input,optional-input</includeregions>
