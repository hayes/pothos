...
[Open the node companion](/playground?example=plugin-relay-nodes). Its source is shown under
...
<include cwd lang="typescript" meta='playground example="plugin-relay-pagination"'>playground-examples/plugin-relay-pagination/schema.ts#connection</include>
