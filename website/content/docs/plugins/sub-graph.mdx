...
<include cwd lang="typescript" meta='playground example="plugin-sub-graph"'>playground-examples/plugin-sub-graph/schema.ts#definitions</include>

The `subGraph` option selects which types and fields appear in the built schema:

<include cwd lang="typescript" meta='playground example="plugin-sub-graph" tab="Public"'>playground-examples/plugin-sub-graph/schema.ts#selection</include>

<include cwd lang="typescript" meta='playground example="plugin-sub-graph-variant-internal" tab="Internal"'>playground-examples/plugin-sub-graph/variant-internal/schema.ts#selection</include>

<include cwd lang="typescript" meta='playground example="plugin-sub-graph-variant-combined" tab="Combined"'>playground-examples/plugin-sub-graph/variant-combined/schema.ts#selection</include>

<include cwd lang="typescript" meta='playground example="plugin-sub-graph-variant-shared" tab="Shared"'>playground-examples/plugin-sub-graph/variant-shared/schema.ts#selection</include>
