...
`complexityFromQuery` scores a query outside of execution, which is useful for logging costs, rejecting requests at the edge, or asserting on complexity in tests.
