...
<Callout type="info">
  See also: [Object types](../fundamentals/objects) for the refs these methods return, [Scalars](../fundamentals/scalars) for defining scalars from scratch, or [Printing and codegen](../patterns/printing-and-codegen) for exporting the merged schema back out to SDL.
</Callout>
