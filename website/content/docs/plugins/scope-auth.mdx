...
<include cwd lang="typescript" meta='playground example="plugin-scope-auth"'>playground-examples/plugin-scope-auth/schema.ts#scopes</include>

<include cwd lang="typescript" meta='playground example="plugin-scope-auth"'>playground-examples/plugin-scope-auth/schema.ts#protected-fields</include>
...
<include cwd lang="typescript" meta='playground example="plugin-scope-auth"'>playground-examples/plugin-scope-auth/schema.ts#protected-write</include>
