...
/>
  ...
  <Card
    ...
    description={'Modern validation using StandardSchemaV1 compatible libraries like Zod, Valibot, and ArkType'}
  />

  <Card
    title="Zod Validation (zod v3)"
    href="/docs/plugins/zod"
    description={'Zod v3-specific validation plugin'}
  />
</Cards>
