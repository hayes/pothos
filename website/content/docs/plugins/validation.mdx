...
<include cwd lang="typescript" meta='playground example="validation-plugin"'>playground-examples/validation-plugin/schema.ts#register-mutation</include>
...
<include cwd lang="typescript" meta='playground example="validation-plugin"'>playground-examples/validation-plugin/schema.ts#signup-input</include>
