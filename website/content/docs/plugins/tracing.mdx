...
<include cwd lang="typescript" meta='playground example="plugin-tracing-lifecycle"'>playground-examples/plugin-tracing-lifecycle/schema.ts#tracer</include>

<include cwd lang="typescript" meta='playground example="plugin-tracing-lifecycle"'>playground-examples/plugin-tracing-lifecycle/schema.ts#lifecycle</include>
