...
```package-install
@pothos/tracing-opentelemetry @opentelemetry/semantic-conventions @opentelemetry/api
```
...
```package-install
@pothos/tracing-newrelic newrelic @types/newrelic
```
...
```package-install
@pothos/tracing-sentry @sentry/node
```
...
```package-install
@pothos/tracing-xray aws-xray-sdk-core
```
