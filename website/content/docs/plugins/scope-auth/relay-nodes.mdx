...
<include cwd lang="typescript" meta='playground example="plugin-scope-auth-variant-private-nodes" op="1"'>playground-examples/plugin-scope-auth/variant-private-nodes/builder.ts#node-lookup-gates</include>
...
<include cwd lang="typescript" meta='playground example="plugin-scope-auth-variant-private-nodes" op="2"'>playground-examples/plugin-scope-auth/variant-private-nodes/builder.ts#node-interface-policy</include>
...
An interface login requirement would also block the anonymous featured-article path later in this
guide. Its parent grant satisfies the article's own policy; it does not override a separate
interface requirement. Choose a baseline that matches which parts of your API are public.
...
<include cwd lang="typescript" meta='playground example="plugin-scope-auth-variant-private-nodes" op="1"'>playground-examples/plugin-scope-auth/variant-private-nodes/schema.ts#query-default</include>
...
<include cwd lang="typescript" meta='playground example="plugin-scope-auth" op="9"'>playground-examples/plugin-scope-auth/builder.ts#scopes</include>

The node accepts either the read permission or a grant from its parent field:

<include cwd lang="typescript" meta='playground example="plugin-scope-auth" op="8"'>playground-examples/plugin-scope-auth/nodes.ts#article-node</include>
...
<include cwd lang="typescript" meta='playground example="plugin-scope-auth" op="8"'>playground-examples/plugin-scope-auth/nodes.ts#featured-article</include>
...
<include cwd lang="graphql">playground-examples/plugin-scope-auth/08-node-paths.graphql</include>
