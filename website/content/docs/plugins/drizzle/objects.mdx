...
that query. This field uses the public User type from the [publishing schema](./relations#published-posts-and-profiles):

<include cwd lang="typescript" meta='playground example="plugin-drizzle"'>playground-examples/plugin-drizzle/schema.ts#author-query</include>
