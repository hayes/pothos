...
Pothos development is supported by [sponsorships](https://github.com/sponsors/hayes) from these
generous people and organizations:

- <a href="https://www.the-guild.dev/">
    <img className="inline-block" style={{ margin: 0 }} alt="The Guild" src="/assets/the-guild-logo.svg" />
  </a>
- <a href="https://www.prisma.io/">
    <img className="inline-block" style={{ margin: 0 }} alt="Prisma" src="/assets/prisma-logo.svg" />
  </a>
- <a href="https://github.com/">
    <img className="inline-block" style={{ margin: 0 }} alt="GitHub" src="/assets/github-logo.svg" />
  </a>
- <img className="inline-block" style={{ margin: 0 }} alt="Stellate" src="/assets/stellate-logo.svg" />
...
- <a href="https://github.com/IPS-Hosting">
    <img className="inline-block" style={{ margin: 0 }} alt="IPS Hosting" src="/assets/ips-logo.svg" />
  </a>
