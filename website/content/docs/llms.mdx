...
Get the MDX content for any individual documentation page in an LLM-friendly format. Append `.mdx` to any docs path to retrieve that page's content in a clean, parseable format.
