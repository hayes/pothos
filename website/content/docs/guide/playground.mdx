...
description: Run a Pothos schema, edit its source, and use variables to explore your data.
---
...
[Open the greeting example](/playground?example=playground-tour&step=1) and click **Run**. The response contains `"Hello, Sam!"`.
