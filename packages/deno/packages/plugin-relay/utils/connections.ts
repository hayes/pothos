// @ts-nocheck
import { type MaybePromise, PothosValidationError, type SchemaTypes, decodeBase64, encodeBase64, } from '../../core/index.ts';
import type { ConnectionShape, DefaultConnectionArguments } from '../types.ts';
...
export async function resolveOffsetConnection<T, U extends Promise<readonly T[] | null> | readonly T[] | null, C extends number | undefined = undefined>(options: ResolveOffsetConnectionOptions & {
    totalCount?: C;
}, resolve: (params: {
    offset: number;
    limit: number;
