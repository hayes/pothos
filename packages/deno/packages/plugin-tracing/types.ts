...
export type TracingFieldWrapper<Types extends SchemaTypes> = (resolver: GraphQLFieldResolver<unknown, Types["Context"], Record<string, unknown>>, value: Exclude<Types["Tracing"], false | null>, fieldConfig: PothosOutputFieldConfig<Types>) => GraphQLFieldResolver<unknown, Types["Context"], Record<string, unknown>>;
