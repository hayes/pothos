...
export class ImplementableInputObjectRef<Types extends SchemaTypes, T extends object, Resolved = T> extends InputObjectRef<Types, Resolved> {
    ...
    implement(options: PothosSchemaTypes.InputObjectTypeOptions<Types, InputFieldsFromShape<Types, T, "InputObject">>): InputObjectRef<Types, Resolved> {
        this.builder.inputType<ImplementableInputObjectRef<Types, T>, InputFieldsFromShape<Types, T, "InputObject">>(this as never, options);
        return this;
    }
}
