// @ts-nocheck
import { type FieldKind, type PothosOutputFieldConfig, type PothosTypeConfig, type SchemaTypes, outputFieldShapeKey, } from '../types/index.ts';
export class FieldRef<Types extends SchemaTypes, T = unknown, Kind extends FieldKind = FieldKind> {
    ...
    private initConfig: (name: string, typeConfig: PothosTypeConfig) => PothosOutputFieldConfig<Types>;
    ...
    updateConfig(cb: (config: PothosOutputFieldConfig<Types>) => PothosOutputFieldConfig<Types> | undefined) {
