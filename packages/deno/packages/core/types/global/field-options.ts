...
import type { FieldNullability, FieldRequiredness, InputFieldMap, InputShapeFromFields, InputShapeFromTypeParam, InputType, Resolver, SchemaTypes, ShapeFromTypeParam, Subscriber, TypeParam, } from '../../index.ts';
declare global {
