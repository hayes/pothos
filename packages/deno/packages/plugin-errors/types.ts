// @ts-nocheck
import { EmptyToOptional, FieldNullability, InferredResolveOptionsKeys, Normalize, SchemaTypes, TypeParam, } from '../core/index.ts';
...
export type ErrorFieldOptions<Types extends SchemaTypes, Type extends TypeParam<Types>, Shape, Nullable extends FieldNullability<Type>> = EmptyToOptional<{
    ...
    } : false, {}, Shape>, "args" | "nullable" | "type" | InferredResolveOptionsKeys> & {
        name?: string;
    }>;
}>;
