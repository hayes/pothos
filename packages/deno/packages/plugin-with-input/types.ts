// @ts-nocheck
import { FieldNullability, InputFieldMap, InputFieldRef, InputRef, InputShapeFromFields, SchemaTypes, TypeParam, } from '../core/index.ts';
export interface WithInputBuilderOptions<Types extends SchemaTypes> {
    inputArgOptions: Omit<PothosSchemaTypes.ArgFieldOptions<Types, InputRef<{}>, true>, "fields" | "required" | "type">;
}
