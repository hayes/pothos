...
export type DataloaderObjectTypeOptions<Types extends SchemaTypes, Shape, Key extends bigint | number | string, Interfaces extends InterfaceParam<Types>[], CacheKey> = ObjectTypeOptions<Types, ObjectRef<Shape>, Shape, Interfaces> & {
