...
import { FieldKind, FieldNullability, FieldOptionsFromKind, InputFieldMap, InputShapeFromFields, InterfaceParam, Resolver, SchemaTypes, ShapeFromTypeParam, TypeParam, } from '../core/index.ts';
...
export type DataloaderObjectTypeOptions<Types extends SchemaTypes, Interfaces extends InterfaceParam<Types>[], Shape extends object, Key extends bigint | number | string, CacheKey> = {
