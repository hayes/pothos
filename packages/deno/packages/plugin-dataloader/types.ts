...
import { FieldKind, FieldNullability, FieldOptionsFromKind, InputFieldMap, InputShapeFromFields, MaybePromise, OutputShape, Resolver, SchemaTypes, ShapeFromTypeParam, TypeParam, } from '../core/index.ts';
...
export type DataloaderObjectTypeOptions<Types extends SchemaTypes, Shape, Key extends bigint | number | string, CacheKey> = Omit<GiraphQLSchemaTypes.ObjectTypeOptions<Types, Shape>, "isTypeOf"> & {
...
export type LoadableNodeOptions<Types extends SchemaTypes, Shape extends object, Key extends bigint | number | string, CacheKey> = DataloaderObjectTypeOptions<Types, Shape, Key, CacheKey> & {
    id: Omit<FieldOptionsFromKind<Types, Shape, "ID", false, {}, "Object", Shape, MaybePromise<OutputShape<Types, "ID">>>, "args" | "nullable" | "type">;
    isTypeOf: (obj: OutputShape<Types, unknown>, context: Types["Context"], info: GraphQLResolveInfo) => boolean;
};
