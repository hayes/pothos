// @ts-nocheck
import { FieldKind, FieldNullability, FieldRef, InputFieldMap, InterfaceParam, OutputShape, SchemaTypes, TypeParam, } from '../core/index.ts';
import { DataloaderObjectTypeOptions, LoadableFieldOptions } from './types.ts';
...
declare global {
    export namespace GiraphQLSchemaTypes {
        ...
        export interface SchemaBuilder<Types extends SchemaTypes> {
            loadableObject: <Interfaces extends InterfaceParam<Types>[], Shape extends OutputShape<Types, Interfaces[number]> & object, Key extends bigint | number | string, CacheKey = Key>(name: string, options: DataloaderObjectTypeOptions<Types, Interfaces, Shape, Key, CacheKey>) => Omit<LoadableObjectRef<Types, Key | Shape, Shape, Key, CacheKey>, "implement">;
        }
