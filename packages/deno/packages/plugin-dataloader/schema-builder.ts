...
import SchemaBuilder, { createContextCache, FieldRef, InterfaceParam, InterfaceRef, SchemaTypes, } from '../core/index.ts';
...
schemaBuilderProto.loadableObject = function loadableObject<Shape extends object, Key extends bigint | number | string, Interfaces extends InterfaceParam<SchemaTypes>[], CacheKey = Key>(name: string, { load, loaderOptions, ...options }: DataloaderObjectTypeOptions<SchemaTypes, Shape, Key, Interfaces, CacheKey>) {
