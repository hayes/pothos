...
and subscription roots follow the same rule. Inherited interface fields also take precedence, and
local overrides can be added before or after building the schema.
